import { ThorinButton, ThorinAvatar, ThorinLabel, ThorinTag, ThorinModal, ThorinConnectModal, setupConfig } from '@ens-tools/thorin-react'
...
function App() {
  ...
  return (
    <>
      <h1>I'm a React app using Thorin for Webcomponents</h1><h2>Avatars</h2><ThorinAvatar name="jontes.eth" /><h2>Buttons</h2><div style={{
        display: "flex",
        flexDirection: "row",
        gap: "10px"
      }}>
      ...
      </div><ThorinModal open={testModal} modalTitle="Modal Title" onClose={() => setTestModal(false)} closeOnRequest={true}>
        <p>Modal Content</p>
      </ThorinModal>
